...
<!-- content here -->
				...
				<div class="col-md-9 text-center">
					<h3 class="col-md-offset-2 col-md-7 text-center">Enter an IMSI and time period for number of failures and their duration</h3>
					<br /><br /><br />
					<form method="get" action="/JPASprint1/webpages/networkManEng/nmeCountNumFailures.jsp" class="form-horizontal">
						<div class="form-group">
							<label for="imsi" class="col-md-4 control-label">IMSI:</label>
							<div class="col-md-4">
								<input type="text" id="query" name="query" value="CountIMSIByTimePeriod" style="display: none" />
